...
class RESTMethods {
  ...
  deleteMessage(message) {
    return new Promise((resolve, reject) => {
      this.rest.makeRequest('del', Constants.Endpoints.base10Message(message.channel.id, message.id), true)
        .then(() => {
  ...
  updateMessage(message, content) {
    return new Promise((resolve, reject) => {
      ...
      this.rest.makeRequest('patch', Constants.Endpoints.base10Message(message.channel.id, message.id), true, {
        content,
      }).then(data => {
  ...
  getChannelMessage(channel, messageID) {
    return new Promise((resolve, reject) => {
      ...
      const endpoint = Constants.Endpoints.base10Message(channel.id, messageID);
